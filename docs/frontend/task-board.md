...
| F0-T03 | F0    | ESLint six-layer boundaries + ban `fetch` outside api-client | Lint fails on deliberate layer violation and stray `fetch`                    | doing  |
...
1. F0-T03 (ESLint boundaries)
2. F0-T04 → F0-T07 in order (api-client load-bearing pieces)
